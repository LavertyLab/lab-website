...
````{r, fig.align = "center", out.width = "80%", fig.cap="Our lab's logo! Designed by NMSU undergraduate student, Cyrillus Sidhe."}
knitr::include_graphics("images/baticon-largesmallanimals.png")
````


````{r, fig.align = "center", out.width = "80%", fig.cap="July 2026 lab photo of Flor Calderón, Taylor Pichler, Ryan Moore, Holly Whited, and Theresa Laverty. Missing Matt Becker and Melanie Solis Alvarez."}
knitr::include_graphics("images/people/lab2026-july.jpg")
````
